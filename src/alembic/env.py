...
# Ensure project root is on sys.path so `import src` works when running alembic
...
#     """
#     Bỏ qua toàn bộ bảng Airflow khi Alembic autogenerate
#     """
#     if type_ == "table":
#         airflow_prefixes = (
#             "dag",
...
#         if name.startswith(airflow_prefixes):
#             return False
